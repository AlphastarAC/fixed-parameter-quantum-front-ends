...
This repository hosts the **locked reproducibility archive** and documentation for the accepted paper. The archive contents are published **byte-identical** to the submission package (no edits to source that would invalidate the declared automated scientific-contract tests).
